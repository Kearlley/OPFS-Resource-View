...
- 🔄 **角标自动更新**：浏览器标签加载时自动更新文件计数角标，使用content script检测OPFS文件
...
├── src/              # 源代码
│   ├── components/   # React 组件
│   │   ├── DataGrid.jsx          # SQLite 数据表格组件
│   │   ├── DatabaseInfo.jsx      # 数据库元信息组件
│   │   ├── FileTree.jsx          # OPFS 文件系统树组件
│   │   ├── Pagination.jsx        # 数据浏览分页组件
│   │   ├── SchemaBrowser.jsx     # 数据库 schema 浏览组件
│   │   ├── SchemaMeta.jsx        # Schema 元数据组件
│   │   └── SqliteViewer.jsx      # SQLite 数据库查看器组件
│   ├── hooks/        # 自定义 React hooks
│   │   ├── useAppState.js        # 应用状态管理
│   │   ├── useDatabaseOperations.js # 数据库操作工具
│   │   └── useFileOperations.js  # 文件系统操作工具
│   ├── utils/        # 工具函数
│   │   ├── base64.js             # Base64 编码/解码工具
│   │   ├── helpers.js            # 通用辅助函数
│   │   ├── opfs.js               # OPFS 文件系统工具
│   │   └── sqlite.js             # SQLite 数据库工具
│   ├── constants.js              # 常量值
...
├── content-script.js             # 用于角标更新的内容脚本
├── devtools.html                 # DevTools 面板 HTML
├── panel.html                    # 扩展面板 HTML
